...
public class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_전달_받을_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/1"))
                ...
                .andExpect(jsonPath("$.email").value("hyunlee.289@gmail.com"))
                .andExpect(jsonPath("$.nickname").value("hyun"))
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/users/me")
                                .header("EMAIL", "hyunlee.289@gmail.com"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.email").value("hyunlee.289@gmail.com"))
                .andExpect(jsonPath("$.nickname").value("hyun"))
    ...
    void 사용자는_내_정보를_수정할_수_있다() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.email").value("hyunlee.289@gmail.com"))
                .andExpect(jsonPath("$.nickname").value("jonghyun"))
                .andExpect(jsonPath("$.address").value("deokso"))
                .andExpect(jsonPath("$.status").value("ACTIVE"));
    }
}
